  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch("/api/ai", {
        ...
        body: JSON.stringify({ toolId: "ai-api-docs-generator", prompt }),
      });
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between pb-4 border-b border-zinc-200/80">
        ...
        <span className="text-xs text-zinc-400 font-mono">Express, FastAPI, Spring, Next.js</span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              placeholder="Paste Express, FastAPI, Spring Boot, or Next.js route code..."
              rows={8}
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {loading ? (
                <>
                  <Zap className="w-4 h-4 animate-spin" /> Generating API Docs...
                </>
              ) : (
                <>
        ...
        <div className="space-y-2">
          ...
          <div className="w-full h-[360px] rounded-xl bg-white border border-zinc-200/90 p-4 text-zinc-800 font-mono text-xs overflow-auto shadow-xs leading-relaxed">
            {output ? (
